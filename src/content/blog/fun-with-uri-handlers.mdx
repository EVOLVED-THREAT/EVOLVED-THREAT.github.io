...
description: Take a look into how custom URI schemes can be used to leverage underlying vulnerabilities in applications.
pubDate: 2019-05-22T12:00:00.000Z
updatedDate: 2019-05-22T12:00:00.000Z
hero: ~/assets/heros/clara.png
heroAlt: Origin Client URI Handler Vulnerability
authors: [
  {
    name: "Dominik Penner",
    handle: "zer0pwn"
...
![Origin Regedit](~/assets/origin_regedit.png)
...
![Origin Arginj](~/assets/origin_reverse.png)
...
![Origin Arginj](~/assets/origin_reverse_poc.png)
...
![Origin Arginj](~/assets/imageformats_plugins.png)
...
![Origin Arginj](~/assets/origin_remote_plugin.png)
...
![Origin Arginj](~/assets/create_payload.png)
...
![Origin Arginj](~/assets/remote_share.png)
...
![Origin Arginj](~/assets/opened_from_firefox.png)
...
![Origin Arginj](~/assets/origin_win10.png)
