...
description: Analysis of CVE-2019-14744, a command injection vulnerability discovered in KDE Frameworks' KConfig class affecting versions below 5.61.0.
pubDate: 2019-08-11T12:00:00.000Z
updatedDate: 2019-08-11T12:00:00.000Z
hero: ../../assets/heros/kdelogo.png
heroAlt: KDE Desktop Vulnerability
authors: [
  {
    name: "Dominik Penner",
    handle: "zer0pwn"
...
![KDE Vulnerability Demo](../../assets/kde-vuln.gif)
...
![Gwenview Config](../../assets/gwenviewrc.png)
...
![Gwenview Config Modified](../../assets/gwenviewrc2.png)
...
![Gwenview Config Executed](../../assets/gwenviewrc3.png)
...
![KDE Thought Process](../../assets/kdethoughtprocess1.png)
...
![Zero Desktop](../../assets/zerololdesktop.png)

import YouTubeEmbed from '@components/MDX/YouTubeEmbed.astro'

<YouTubeEmbed id="l4z7EOQQs84" title="KDE Desktop Vulnerability Demo" />
...
#### kconfiggroup.cpp
![KConfig Read Entry](../../assets/kconfiggroup_readentry.png)
...
#### kconfig.cpp
![KConfig Expand String](../../assets/kconfiggroup_expandstring.png)
...
#### kdesktopfile.cpp
![KDesktop File](../../assets/kdesktopfile.png)
...
![Easy Hiding](../../assets/easyhiding.png)
...
![Easier Hiding](../../assets/easierhiding.png)
...
* [Nux](https://x.com/ItsNux)
* [yuu](https://x.com/netspooky)
